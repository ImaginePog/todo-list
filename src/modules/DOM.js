const DOM = (() => {
  ...
  function loadObjects() {
    ...
    queryObject(".none-btn-edit", objects[".edit-task-form"].object);
    queryObject(".high-btn-edit", objects[".edit-task-form"].object);
    queryObject(".low-btn-edit", objects[".edit-task-form"].object);
